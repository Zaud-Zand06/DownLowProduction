...
import provencalSando from '../assets/provencal800.avif';
import hoeCakes from '../assets/hoeCake1200.avif';

const menuImages = [
  {
    name: 'Provençal Sando',
    price: 18.99,
    imageSrc: provencalSando,
    altText:
      'Fried Chicken sandwhich with sauteed veggie slaw, and chicken gravy mayo.',
  },
  {
    name: 'Hoe Cakes',
    price: 5.99,
    imageSrc: hoeCakes,
    altText:
      'A stack of golden brown cornmeal flatbreads, stacked with honey butter on top.',
  },
  {
    name: 'Paisano Sando',
    price: 18.99,
...
const sandosList = [
  {
    title: 'The Provençal Sando',
    description:
      'Chicken Gracy Mayo, Sauteed Veggie Slaw, Herbs de Provence Dust',
    price: 18.99,
...
const sidesList = [
  {
    title: 'Hoe Cakes',
    description: 'Savory Cornmeal Flatbread, served with honey butter',
    price: 5.99,
    special: 'Limited time only!',
  },
  {
